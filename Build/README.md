...
- **Windows**
  ...
  - Visual Studio 2022/2026 with MSVC v143 or later
...
or build with CMake command line to generate Visual Studio 2026 solution:
...
```console
./Build/Windows/Build.bat [--vs2022] [--win32] [--debug] [--vulkan] [--graphviz] [--tracy] [--itt] [--cpu_profile] [--gpu_profile] [--logs] [--analyze SONAR_TOKEN]
```
...
| Presets Matrix | VS2022|VS2026 | Xcode     | Make      | Ninja   |   
|----------------|---------------|-----------|-----------|---------|
| Win64          | DX / VK       | -         | -         | -       |
| Win32          | DX / VK       | -         | -         | -       |
| Win            | -             | -         | -         | DX / VK |
...
CMake presets can be also used in [VS2026 and VS Code](https://devblogs.microsoft.com/cppblog/cmake-presets-integration-in-visual-studio-and-visual-studio-code/)
