...
function(get_target_resources_dir FOR_TARGET RESOURCES_DIR IS_CONSOLE_APP)
    set(TARGET_DIR $<TARGET_FILE_DIR:${FOR_TARGET}>)
    if(APPLE_MACOS AND NOT IS_CONSOLE_APP)
...
function(add_prerequisite_binaries TO_TARGET FROM_TARGETS INSTALL_DIR IS_CONSOLE_APP)
    foreach(FROM_TARGET ${FROM_TARGETS})
    ...
    if (COPY_ALL_RESOURCES)
        get_target_resources_dir(${TO_TARGET} RESOURCES_DIR ${IS_CONSOLE_APP})
        add_custom_command(TARGET ${TO_TARGET} POST_BUILD
